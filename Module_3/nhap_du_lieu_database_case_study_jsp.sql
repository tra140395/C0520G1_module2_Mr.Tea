...
insert into service values
  (1,'asds',35,200000,4,6,3,'Rong rai','thong thoang',0,1),
  (2,'fsdf',40,700000,6,3,3,'sach se','thue cho ban',0,2),
  (3,'sdads',60,800000,4,2,3,'Dep','Giam gia',30,2),
  (4,'wrwwe',64,200000,1,5,3,'Vua phai','thue de choi',0,1),
  (5,'jyjtt',100,1000000,8,1,3,'cao','thue di du lich',50,3),
  (6,'ryerr',203,2000000,5,4,3,'Nhieu tang','thue cho vui',70,3);
  
insert into contract values
  (1,'2020-06-21','2020-09-21',100000,500000,6,3,1), 
  (2,'2019-03-13','2020-01-11',100000,700000,3,2,3),
  (3,'2020-01-21','2020-09-03',200000,500000,2,6,4),
  (4,'2018-06-12','2019-02-17',100000,300000,2,3,4),
  (5,'2020-01-11','2020-03-22',200000,800000,5,2,3),
  (6,'2019-07-28','2019-10-12',200000,1000000,4,5,1);
