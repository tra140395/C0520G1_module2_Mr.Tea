...
public class Customer {
    ...
    public Customer(String customer_id, int customer_type_id, String customer_name, String customer_birthday,
                    int customer_gender, String customer_id_card, String customer_phone,
